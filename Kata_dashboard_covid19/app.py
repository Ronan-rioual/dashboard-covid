...
@app.route('/')
def page():
    donnees = focus('donnes/d5.csv')
    donnees3 = moyby('donnes/d5.csv')
    donnees4 = dephop('donnes/d5.csv')
    donnees5 = piehf('donnes/d5.csv')
    #donnees6 = openfile6('donnes/d5.csv')
    donnees7 = hopdep2('donnes/d5.csv')
