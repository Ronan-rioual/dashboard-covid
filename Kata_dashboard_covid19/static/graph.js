Highcharts.chart('container', {
    ...
    title: {
      text: 'Nombre d\'hospitalisations et de personne en réanimation sur la période du  18/03/2020 au 21/01/2021, Source: data.com'
         },
  ...
  Highcharts.chart('container1', {
    ...
    title: {
      text: 'Nombre de retour à domicile et de décès cumulés sur la période du 18/03/2020 au 21/01/2021, Source: data.com'
         },
...
Highcharts.chart('container4', {
  ...
  xAxis: {
    categories: Object.values(donnees4frompython.dep),
    tickInterval: 1,
    lineWidth: 0
  },
  yAxis: {
